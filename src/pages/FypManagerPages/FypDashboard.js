...
const DbFypInch = () => {
    ...
    const fypsection = [
        {
            ...
            options: [
                { name: 'Manage Assessments', link: '/external-assessmentpage' },
                { name: 'Manage Assessment Criterias', link: '/create-assessmentpage' },
    ...
    const renderGroupGraph = () => {
        return (
            <div style={{justifyContent: 'center', alignItems: 'center', height: '100%', display: 'flex', overflowX: 'auto', overflowY: 'hidden' }}>
    ...
    const renderGroups = () => {
        ...
        return (
            ...
            <div style={{ justifyContent: 'center', alignItems: 'center', height: '100%' }}>
                ...
                <BarChart width={400} height={280} data={data}
                >
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="name" />
                    <YAxis />
            ...
            <Header>
                ...
                <section style={styles.section}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <Card icon={faUserTie} title="Supervisors" available={30} styles={styles} />
                        <Card icon={faUsers} title="Fyp Groups" available={totalGroupsAcrossDegrees} styles={styles} />
                    </div>
                    <div>
                        {renderGroupGraph()}
